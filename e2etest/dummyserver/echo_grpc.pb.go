...
type TestServiceClient interface {
	...
	EmptyCall(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*EmptyResponse, error)
}
...
func (c *testServiceClient) EmptyCall(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TestServiceServer interface {
	...
	EmptyCall(context.Context, *empty.Empty) (*EmptyResponse, error)
...
func (UnimplementedTestServiceServer) EmptyCall(context.Context, *empty.Empty) (*EmptyResponse, error) {
