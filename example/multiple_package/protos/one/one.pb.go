...
func (c *giroServiceClient) GiroTest1(ctx context.Context, in *GiroTestRequest1, opts ...grpc.CallOption) (*GiroTestResponse1, error) {
	...
	err := c.cc.Invoke(ctx, "/example.multiple_package.protos.one.GiroService/GiroTest1", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *giroServiceClient) GiroTest2(ctx context.Context, in *GiroTestRequest2, opts ...grpc.CallOption) (*GiroTestResponse2, error) {
	...
	err := c.cc.Invoke(ctx, "/example.multiple_package.protos.one.GiroService/GiroTest2", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedGiroServiceServer can be embedded to have forward compatible implementations.
...
func RegisterGiroServiceServer(s *grpc.Server, srv GiroServiceServer) {
	s.RegisterService(&_GiroService_serviceDesc, srv)
}
...
func _GiroService_GiroTest1_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.multiple_package.protos.one.GiroService/GiroTest1",
	}
...
func _GiroService_GiroTest2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.multiple_package.protos.one.GiroService/GiroTest2",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _GiroService_serviceDesc = grpc.ServiceDesc{
